...
#[function_component(EditPublisherModal)]
pub fn edit_publisher_modal(props: &Props) -> Html {
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="edit-publisher-name" class="form-label">{ "Name " }</label>
                        <input class="form-control" type="text" id="edit-publisher-name" name="name"
                            ref={ name_ref }
