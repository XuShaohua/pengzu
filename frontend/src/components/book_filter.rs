...
pub fn book_filter(props: &Props) -> Html {
    ...
    html! {
        ...
        <button type="button" class={ get_button_cls(GetBooksOrder::PubdateAsc) }
            title={ "Sort according to publishing date, newest first" }
            onclick={ button_onclick(GetBooksOrder::PubdateAsc) }>
            <i class="bi bi-calendar-date"></i>
            <i class="bi bi-sort-numeric-down"></i>
        </button>
        <button type="button" class={ get_button_cls(GetBooksOrder::PubdateDesc) }
